    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_arrowb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tuesday.this, WeekActivity.class);
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Clase").child("V").child("Orar").child("Marti");
